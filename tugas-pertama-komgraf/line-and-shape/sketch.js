...
function addPolygon() {
  ...
  for (var i = 1; i <= vertextTotal; i++) {
    inputHtml += '<input id="poly-x1-' + i + '" type="number" name="" value="" placeholder="Coordinate x' + i + '">';
    inputHtml += '<input id="poly-y1-' + i + '" type="number" name="" value="" placeholder="Coordinate y' + i + '">';
  }
